    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc">Isi form di bawah untuk menambah <code> Data Siswa</code>.</p>
                <form method="POST" action="{{route('dashboard.students.store')}}" id="frmStore">
                    @csrf
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="username" placeholder="NISN" value="{{old('username')}}" required>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-md-2 col-form-label">Jurusan <span class="text-danger">*</span></label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="study_program" placeholder="Jurusan" value="{{old('study_program')}}" required>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-md-2 col-form-label">Offering <span class="text-danger">*</span></label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="offering" placeholder="Offering" value="{{old('offering')}}" required>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-10">
                            ...
                            <p class="text-info" style="margin-top: 0px;margin-bottom: 0px;padding-top: 0px;padding-bottom: 0px;"><small><i>Kosongkan jika ingin menggunakan password yang sama dengan nisn</i></small></p>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
