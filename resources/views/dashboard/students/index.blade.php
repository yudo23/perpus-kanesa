    ...
    <div class="col-md-12">
        <div class="card m-b-30 px-3">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-lg-12">
                        <a href="{{route('dashboard.students.create')}}" class="btn btn-primary btn-sm btn-add"><i class="fa fa-plus"></i> Tambah</a>
                        <a href="#" class="btn btn-warning btn-sm btn-filter text-white"><i class="fa fa-filter"></i> Filter</a>
                        <a href="#" class="btn btn-info btn-sm btn-import-excel"><i class="fa fa-upload"></i> Import</a>
                        <a href="{{route('dashboard.students.index')}}" class="btn btn-secondary btn-sm"><i class="fa fa-refresh"></i> Refresh</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                                ...
                                <table class="table mb-3 table-striped table-bordred">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('dashboard.students.show',$row->id)}}" class="btn btn-info btn-sm">Detail</a>
                                                <a href="{{route('dashboard.students.edit',$row->id)}}" class="btn btn-primary btn-sm">Ubah</a>
                                                ...
                                                <a href="{{route('dashboard.students.impersonate',$row->id)}}" class="btn btn-success btn-sm btn-delete">Login</a>
                                                @endif
                                            </td>
                                        </tr>
                                        @empty
...
@include("dashboard.students.modal.index")
    ...
    $(function() {
        ...
        $(document).on('submit','#frmImportExcel',function(e){
            ...
            if(confirm("Apakah anda yakin ingin menyimpan data ini ?")){
                $.ajax({
                    url : $("#frmImportExcel").attr("action"),
                    method : "POST",
                    data : new FormData($('#frmImportExcel')[0]),
                    contentType:false,
                    cache:false,
                    processData:false,
                    dataType : "JSON",
